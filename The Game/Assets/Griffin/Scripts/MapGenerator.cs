...
public class MapGenerator : MonoBehaviour
{
    ...
    [field: SerializeField] public MapType Type { get; set; }
    ...
    {
        Transform transform = Utils.PickRandom(Parameters.PlayerSpawnPoints).transform;
        
        GameObject player = Instantiate(Type.Player, transform);
    ...
    {
        bool remove = !room.HasRoomLeaf && !room.IsEntry;
